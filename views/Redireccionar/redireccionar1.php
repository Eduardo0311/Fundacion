...
<section>
    <div class="row row justify-content-center ps-5 pe-5 pt-4">    
            ...
            ?>  
                ...
                <!--AREA DE WIDWET
                <div class="col-xl-3 col-lg-3 d-none d-lg-block" style="background-color: red;">
                    <div>
                        <h4 class="text-center" style="font-size: large;">¡Síguenos en nuestras redes para saber sobre nuestras noticias cuanto antes!</h4>
                    </div>      
                </div>-->
